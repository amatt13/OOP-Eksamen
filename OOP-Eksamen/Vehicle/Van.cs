...
namespace OOP_Eksamen{
    class Van : PersonVehicle {//inherited from PeronVehicle which is inherited from Vehicle
        ...
        public int Freightcapacity{
            ...
            set {//The licence is BE if the van is above 750, otherwise a B licence is required.
