    ...
    class Truck : Vehicle{
        ...
        public double Weight{
            ...
            set{
                ...
                else{//An exception will be trown if the weight is set to 0, negative number or a NAN
        ...
        public LicenseType License{
            ...
            set {//The licence is CE if the truck has towhook, otherwise a C licence is required
                if (_towHook == true){
        ...
        public override double EngineSize{
            ...
            set{//There is min and max limit the value has to be inbetween. Otherwise an exception will be thrown
