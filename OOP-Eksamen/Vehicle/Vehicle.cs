...
namespace OOP_Eksamen
{
    ...
    {
        public InvalidRegNumException() : base() { }
        public InvalidRegNumException(string s) : base(s) { }
        public InvalidRegNumException(string s, Exception ex) : base(s, ex) { }
    }
    ...
    abstract class Vehicle
    {
        ...
        public struct Size
        {//To describe Size of Trunk and Truck
        ...
        public string Registration
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidRegNumException("Registration must be 2 letters followed by 5 numbers.");
                }
            }
        }
