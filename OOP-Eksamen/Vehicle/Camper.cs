...
namespace OOP_Eksamen
{
    class Camper : Vehicle{
        ...
        private Heatsource _usedheatsource;//The heatsource is will affect the energyclass
        private uint _seat;
        private uint _beds;
        ...
        public uint Seats{
            ...
            set {//An exception will be trown if the seats is set to 0, a negative number or NAN
                if (value > 0) {
                    _seat = value;
                }
                else {
        ...
        public uint Beds{
            ...
            set{
                if (value < 99) {//This exception hvae been made in a attemt to cath typo
                    _beds = value;
                }
                else {
        ...
        //This will be used in order to get the correct energyclass for the camper
